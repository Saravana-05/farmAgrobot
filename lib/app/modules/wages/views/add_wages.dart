          ...
          child: Column(
            ...
            children: [
              _buildEmployeeMultiselect(
                  context, controller), // CHANGED: From _buildEmployeeDropdown
            ...
            child: Column(
              ...
              children: [
                ...
                _buildPreviewRow(
                  'Employees:',
                  controller
                      .employeePreview, // CHANGED: Now uses employeePreview
...
Widget _buildEmployeeMultiselect(
    BuildContext context, AddWageController controller) {
  return Obx(() {
    ...
    print(
        "selectedEmployees: ${controller.selectedEmployees.map((e) => e.name).toList()}");
...
void _showEmployeeMultiselectDialog(
    BuildContext context, AddWageController controller) {
  showDialog(
    context: context,
                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final isSelected =
                            controller.isEmployeeSelected(employee);

                        return CheckboxListTile(
                          title:
                              Text(controller.getEmployeeDisplayName(employee)),
